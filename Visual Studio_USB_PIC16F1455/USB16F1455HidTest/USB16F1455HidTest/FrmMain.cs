...
namespace USB16F1455HidTest
{
    public partial class FrmMain : Form
    {
        ...
        private const int ProductId = 0x01A5;
        ...
        {
            // Incomming Data cannot be Null, if it is the we are in WTF stage.
            if(value == null) return;

            // Incomming Data Packet cannot be shorter than 8 bytes, See Usb Documentation for details
