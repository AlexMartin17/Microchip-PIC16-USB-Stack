...
namespace UsbHid.USB.Classes
{
    public class DeviceChangeNotifier : Form
    {
        ...
        {
            if (DeviceDetached != null) DeviceDetached(this, null);
            if (DeviceNotify != null) DeviceNotify(this, new EventArgs<Message>(message));
        }

        private void ReportDeviceAttached(Message message)
        {
            if (DeviceAttached != null) DeviceAttached(this, null);
            if (DeviceNotify != null) DeviceNotify(this, new EventArgs<Message>(message));
        }
    }
}
